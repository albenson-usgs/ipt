...
* **Selección del idioma**: en la esquina superior derecha de la página hay un nombre que indica el idioma en el que se presenta actualmente el IPT. El idioma por defecto del IPT es el inglés. Si está disponible, el idioma de la interfaz del usuario se puede cambiar al hacer clic en el idioma deseado. GBIF busca activamente que el IPT sea traducido a otros idiomas. Para obtener más información, consulte la página xref:translations.adoc[Cómo contribuir] (página en ingés).
