...
* *Título*: el título del recurso. Este título aparecerá como el Nombre del recurso en todo el IPT. El título también aparecerá en el Registro GBIF.
...
La sección de *la izquierda* controla la forma cómo se publican las versiones del recurso. El botón "Publicar" puede ser usado para publicar nuevas versiones voluntariamente, mientras que la autopublicación permite publicar nuevas versiones en una fecha programada. Para más explicaciones acerca de esta sección, consulte la información a continuación.

image::ipt2/manage/IPTManageResourcePublishLeftSide2.png[]

* *Publicación a demanda*: al hacer clic en el botón "Publicar" se desencadenará la publicación de una nueva versión. El botón publicar estará activado sí
+
--
...
* *Publicación automática*: para activar la publicación automática, seleccione uno de los 5 intervalos de publicación (anual, semestral, mensual, semanal o diario) y, a continuación, pulse el botón de publicación. Cuando la publicación automática está activada, el intervalo de publicación y la próxima fecha de publicación se muestran claramente en la sección de versiones publicadas. Para cambiar el intervalo de publicación, seleccione un intervalo de publicación diferente y pulse publicar. Para desactivar la publicación automática, seleccione "Desactivar" y pulse publicar. En caso de fallo, la publicación se reintentará automáticamente hasta 3 veces más. De esta forma se evitan los bucles infinitos de publicación. Los recursos configurados para publicarse automáticamente, pero que no hayan finalizado con éxito, tendrán una fecha de próxima publicación en el pasado, y serán resaltados en las tablas de recursos públicos y de gestión.
+
--
...
* *Reporte de publicación*: el resumen de la publicación de la versión actual, no aplica a la versión pendiente.
...
Actualmente no hay una forma sencilla de eliminar un recurso del IPT y mantenerlo en GBIF.org (para dejar intencionadamente "huérfano" el conjunto de datos). Una solución, que requiere acceso al servidor, es mover/borrar el directorio de recursos (como se indica arriba) y reiniciar el IPT. Problema: https://github.com/gbif/ipt/issues/1461
